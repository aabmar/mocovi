...
import { Collection, UseCollection, UseCollectionReturn } from "./types";
import useLog from "./logger";

function createUseCollection<Data extends { id: string }>(store: Collection<Data>): UseCollection<Data> {
